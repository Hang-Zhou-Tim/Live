...
public class GiftProviderCacheKeyBuilder extends RedisKeyBuilder {
    ...
    private static String PK_LIVE_STREAM_KEY = "pk_live_stream_key";
    private static String PK_LIVE_STREAM_SEND_SEQ = "pk_live_stream_send_seq";
    private static String PK_LIVE_STREAM_IS_OVER = "pk_live_stream_is over";
    ...
    public String buildPKLiveStreamIsOver(Integer roomId) {
        return super.getPrefix() + PK_LIVE_STREAM_IS_OVER + super.getSplitItem() + roomId;
    }

    public String buildPKLiveStreamSendSeq(Integer roomId) {
        return super.getPrefix() + PK_LIVE_STREAM_SEND_SEQ + super.getSplitItem() + roomId;
    }

    public String buildPKLiveStreamKey(Integer roomId) {
        return super.getPrefix() + PK_LIVE_STREAM_KEY + super.getSplitItem() + roomId;
    }
